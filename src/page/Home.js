              ...
              <div>
                ...
                <div className='accordion'>
                  <div className='accordionItem'>
                    ...
                    <div className={active === 0 ? 'accordionBodyActive' : 'accordionBody'} >
                  ...
                  <div className='accordionItem'>
                    <h3 className='accordionHead' onClick={() => { setActive(1) }}>덧신{shoes ? ' "' + shoes + '" 를 선택하였습니다' : '을 선택하세요'}</h3>
                    <div className={active === 1 ? 'accordionBodyActive' : 'accordionBody'}>
                  ...
                  <div className='accordionItem'>
                    <h3 className='accordionHead' onClick={() => { setActive(2) }}>장갑{gloves ? ' "' + gloves + '" 를 선택하였습니다' : '을 선택하세요'}</h3>
                    <div className={active === 2 ? 'accordionBodyActive' : 'accordionBody'}>
                  ...
                  <div className='accordionItem'>
                    <h3 className='accordionHead' onClick={() => { setActive(3) }}>방독면{mask ? ' "' + mask + '" 를 선택하였습니다' : '을 선택하세요'}</h3>
                    <div className={active === 3 ? 'accordionBodyActive' : 'accordionBody'}>
